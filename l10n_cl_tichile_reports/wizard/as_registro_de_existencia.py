...
class as_kardex_existencia_wiz(models.TransientModel):
    _name="as.registro.existencia"
    ...
    def export_pdf(self):
        ...
        datas['model'] = 'as.registro.existencia'
        datas['form'] = self.read()[0]
        for field in datas['form'].keys():
            if isinstance(datas['form'][field], tuple):
                datas['form'][field] = datas['form'][field][0]
        return self.env.ref('l10n_cl_tichile_reports.as_registro_de_existencia_pdf').report_action(self, data=datas)
    ...
    def export_xls(self):
        ...
        if context.get('xls_export'):
            return self.env.ref('l10n_cl_tichile_reports.as_registro_de_existencias').report_action(self, data=datas)
