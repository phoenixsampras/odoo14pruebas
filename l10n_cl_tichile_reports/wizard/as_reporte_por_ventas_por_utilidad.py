...
class as_kardex_lista_wiz(models.TransientModel):
    _name="as.resumen.ventas.utilidad"
    ...
    def export_pdf(self):
        ...
        datas['model'] = 'as.resumen.ventas.utilidad'
    ...
    def export_xls(self):
        ...
        if context.get('xls_export'):
            return self.env.ref('l10n_cl_tichile_reports.as_resumen_ventas_utilidad').report_action(self, data=datas)
