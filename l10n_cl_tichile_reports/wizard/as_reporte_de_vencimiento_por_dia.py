...
class as_kardex_productos_wiz(models.TransientModel):
    _name="as.reporte.vencimiento.dia"
    ...
    def export_pdf(self):
        ...
        datas['model'] = 'as.reporte.vencimiento.dia'
        datas['form'] = self.read()[0]
        for field in datas['form'].keys():
            if isinstance(datas['form'][field], tuple):
                datas['form'][field] = datas['form'][field][0]
        return self.env.ref('l10n_cl_tichile_reports.as_reporte_vencimiento_dia_pdf').report_action(self, data=datas)
    ...
    def export_xls(self):
        ...
        if context.get('xls_export'):
            return self.env.ref('l10n_cl_tichile_reports.as_reporte_vencimiento_dia').report_action(self, data=datas)
