...
class as_kardex_productos_wiz(models.TransientModel):
    ...
    def export_pdf(self):
        ...
        datas['model'] = 'as.ventas.sucursal.dia'
        datas['form'] = self.read()[0]
        for field in datas['form'].keys():
            if isinstance(datas['form'][field], tuple):
                datas['form'][field] = datas['form'][field][0]
        return self.env.ref('l10n_cl_tichile_reports.as_ventas_sucursal_dia_pdf').report_action(self, data=datas)
    ...
    def export_xls(self):
        ...
        if context.get('xls_export'):
            return self.env.ref('l10n_cl_tichile_reports.as_ventas.sucursal.dia').report_action(self, data=datas)
