...
class as_kardex_productos_wiz(models.TransientModel):
    ...
    def export_pdf(self):
        ...
        datas['model'] = 'as.resumen.ventas'
        datas['form'] = self.read()[0]
        for field in datas['form'].keys():
            if isinstance(datas['form'][field], tuple):
                datas['form'][field] = datas['form'][field][0]
        return self.env.ref('l10n_cl_tichile_reports.as_resumen_por_ventas_pdf').report_action(self, data=datas)
    ...
    #         return self.env.ref(l10n_cl_tichile_reports.as_resumen_ventas').report_action(self, data=datas)
