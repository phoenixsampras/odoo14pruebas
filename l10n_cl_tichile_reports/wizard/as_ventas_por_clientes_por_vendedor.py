...
class as_kardex_productos_wiz(models.TransientModel):
    _name="as.ventas.cliente.vendedor"
    ...
    def export_pdf(self):
        ...
        datas['model'] = 'as.ventas.cliente.vendedor'
        datas['form'] = self.read()[0]
        for field in datas['form'].keys():
            if isinstance(datas['form'][field], tuple):
                datas['form'][field] = datas['form'][field][0]
        return self.env.ref(l10n_cl_tichile_reports.as_ventas_por_cliente_por_vendedor_pdf').report_action(self, data=datas)
    ...
    def export_xls(self):
        ...
        if context.get('xls_export'):
            return self.env.ref(l10n_cl_tichile_reports.as_ventas_por_cliente_por_vendedor').report_action(self, data=datas)
