...
class as_kardex_lista_wiz(models.TransientModel):
    ...
    def export_pdf(self):
        ...
        datas['model'] = 'as.salida.inventario'
    ...
    def export_xls(self):
        ...
        if context.get('xls_export'):
            return self.env.ref('l10n_cl_tichile_reports.as_salida_inventario_report').report_action(self, data=datas)
