...
class as_sales_libro_ventas_tax(models.AbstractModel):
    _name = 'l10n_cl_tichile_reports.informe.consumo.centro de costo.xlsx'
    _inherit = 'report.report_xlsx.abstract'

    def generate_xlsx_report(self, workbook, data, lines):     
        sheet = workbook.add_worksheet('informe consumo por centro de costo')
        #estilos
        ...
        sheet.merge_range('A1:V1', 'informe consumo por centro de costo', titulo1)
