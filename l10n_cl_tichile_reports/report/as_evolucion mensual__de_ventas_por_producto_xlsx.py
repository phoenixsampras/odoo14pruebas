...
class as_sales_libro_ventas_tax(models.AbstractModel):
    _name = 'l10n_cl_tichile_reports.evolucion mensual.ventas.producto.xlsx'
    _inherit = 'report.report_xlsx.abstract'

    def generate_xlsx_report(self, workbook, data, lines):     
        sheet = workbook.add_worksheet('evolucion mensual de ventas por producto')
        #estilos
        ...
        sheet.merge_range('A1:V1', 'evolucion mensual de ventas por producto', titulo1)
