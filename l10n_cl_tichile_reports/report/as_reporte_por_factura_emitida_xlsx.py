...
class as_sales_libro_ventas_tax(models.AbstractModel):
    _name = 'l10n_cl_tichile_reports.reporte.facturas.emitidas.xlsx'
    _inherit = 'report.report_xlsx.abstract'

    def generate_xlsx_report(self, workbook, data, lines):     
        sheet = workbook.add_worksheet('reporte por facturas emitidas')
        #estilos
        ...
        sheet.merge_range('A1:V1', 'reporte por facturas emitidas', titulo1)
